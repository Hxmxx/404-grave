...
import { FolderX, FileText } from 'lucide-react'
    ...
    return (
        <>
                    ...
                    <Link key={project.id} href={`/projects/${project.id}`}>
                        <ProjectCard
                            ...
                            owner={{
                                ...
                                avatarUrl: project.profiles.avatar_url || '/placeholder-avatar.png',
                            }}
                        />
                    </Link>
                ))}
            ...
            {!hasMore && projects.length > 0 && (
                <div className="mt-12 text-center text-gray-500 mb-12">
                    <p>모든 프로젝트를 확인했습니다.</p>
                </div>
            )}
        </>
